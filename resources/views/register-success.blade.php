...
<head>
    ...
    <title>{{ env('BRAND_NAME') }} - Register Success</title>
...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <p>
                Anda juga dapat cek whatsapp untuk informasi pendaftaran
            </p>
        </div>

        <div class="col-12">
            <img class="img-fluid" src="{{ url('assets/topup.jpg') }}" alt="Image 2">
        </div>
        <div class="col-12">
            Sudah terdaftar?
